...
lv_group_t * ui_dev_manage_group = NULL;
lv_obj_t * ui_dev_manage_title = NULL;
lv_obj_t * ui_dev_manage_title_label = NULL;
lv_obj_t * ui_dev_version_button = NULL;
lv_obj_t * ui_dev_version_label = NULL;
lv_obj_t * ui_lcd_version_button = NULL;
lv_obj_t * ui_lcd_version_label = NULL;
lv_obj_t * ui_password_button = NULL;
lv_obj_t * ui_password_label = NULL;
...
// event funtions
void ui_dev_manage_event(lv_event_t * e)
{
    ...
    switch(event_code)
    {
        ...
        case LV_EVENT_KEY:
            ...
            {
                case LV_KEY_ENTER:
                    if (btn == ui_dev_version_button)
                    {
                        lv_indev_set_group(indev, ui_dev_version_group);
                        _ui_screen_change(&ui_dev_version_title, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_dev_version_screen_init);
                    }
                    if (btn == ui_lcd_version_button)
                    {
                        lv_indev_set_group(indev, ui_lcd_version_group);
                        _ui_screen_change(&ui_lcd_version_title, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_lcd_version_screen_init);
                    }
                    if (btn == ui_password_button)
                    {
                    ...
                    if (btn == ui_ai_switch_button)
                    {
                        lv_indev_set_group(indev, ui_ai_switch_group);
                        _ui_screen_change(&ui_ai_switch_title, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_ai_switch_screen_init);
                    }
                    break;
...
// build funtions
void ui_dev_manage_screen_init(void)
{
    ui_dev_manage_title = lv_obj_create(NULL);
    lv_obj_clear_flag(ui_dev_manage_title, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    /*-----创建设备版本菜单项-----*/
    ui_dev_version_button = lv_btn_create(ui_dev_manage_title);
    ...
    /*-----创建lcd版本菜单项-----*/
    ui_lcd_version_button = lv_btn_create(ui_dev_manage_title);
    ...
    /*-----创建密码菜单项-----*/
    ui_password_button = lv_btn_create(ui_dev_manage_title);
    ...
    /*-----创建遥测切换菜单项-----*/
    ui_ai_switch_button = lv_btn_create(ui_dev_manage_title);
    ...
    lv_group_add_obj(ui_dev_manage_group, ui_dev_version_button);
    lv_group_add_obj(ui_dev_manage_group, ui_lcd_version_button);
    lv_group_add_obj(ui_dev_manage_group, ui_password_button);
    lv_group_add_obj(ui_dev_manage_group, ui_ai_switch_button);

    lv_indev_set_group(indev, ui_dev_manage_group); // 将输入设备与对象组关联

    lv_group_focus_obj(ui_dev_version_button);
}

void ui_dev_manage_screen_destroy(void)
{
    if(ui_dev_manage_title) lv_obj_del(ui_dev_manage_title);

    // NULL screen variables
    ui_dev_manage_title = NULL;
    ui_dev_manage_title_label = NULL;
    ui_dev_version_button = NULL;
    ui_dev_version_label = NULL;
    ui_lcd_version_button = NULL;
    ui_lcd_version_label = NULL;
    ui_password_button = NULL;
    ui_password_label = NULL;
    ui_ai_switch_button = NULL;
    ui_ai_switch_label = NULL;
}
