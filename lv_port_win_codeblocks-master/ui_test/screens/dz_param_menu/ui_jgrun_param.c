...
lv_group_t * ui_jgrun_param_group = NULL;
lv_obj_t * ui_jgrun_param_title = NULL;
lv_obj_t * ui_jgrun_param_title_label = NULL;
...
// event funtions
void ui_jgrun_param_event(lv_event_t * e)
{
...
// build funtions
void ui_jgrun_param_screen_init(void)
{
    ui_jgrun_param_title = lv_obj_create(NULL);
    lv_obj_clear_flag(ui_jgrun_param_title, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_jgrun_param_group = lv_group_create(); // 创建一个新的对象组
    lv_indev_t *indev = lv_win32_keypad_device_object;
...
void ui_jgrun_param_screen_destroy(void)
{
    if(ui_jgrun_param_title) lv_obj_del(ui_jgrun_param_title);

    // NULL screen variables
    ui_jgrun_param_title = NULL;
    ui_jgrun_param_title_label = NULL;
}
