...
void ui_dz_set_screen_init(void)
{
    ...
    lv_obj_set_style_outline_width(ui_dz_set_title, 0, LV_PART_MAIN | LV_STATE_FOCUSED);//关闭所有焦点轮廓
    ...
    {
        printf("Current mode: DZ_VIEW_MODE,current_dz_mode = %d\n", current_dz_mode);
        lv_label_set_text(ui_dz_set_title_label, "dz view");
    }
    else
    {
        printf("Current mode: DZ_SET_MODE,current_dz_mode = %d\n", current_dz_mode);
