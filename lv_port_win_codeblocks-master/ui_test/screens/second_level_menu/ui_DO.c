...
lv_group_t * ui_DO_group = NULL;
lv_obj_t * ui_DO_title = NULL;
lv_obj_t * ui_DO_title_label = NULL;
lv_obj_t * ui_point_DO_button = NULL;
lv_obj_t * ui_point_DO_label = NULL;
lv_obj_t * ui_all_DO_button = NULL;
lv_obj_t * ui_all_DO_label = NULL;
...
// build funtions
void ui_DO_screen_init(void)
{
    ui_DO_title = lv_obj_create(NULL);
    lv_obj_clear_flag(ui_DO_title, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_label_set_text(ui_DO_title_label, "DO");
    lv_obj_set_align(ui_DO_title_label, LV_ALIGN_TOP_MID);
    lv_obj_add_style(ui_DO_title_label, &style_title, 0);

    /*-----创建点表遥控菜单项-----*/
    ui_point_DO_button = lv_btn_create(ui_DO_title);
    lv_obj_set_button_init(ui_point_DO_button, lv_pct(100), 20);
    lv_obj_align_to(ui_point_DO_button, ui_DO_title_label, LV_ALIGN_OUT_BOTTOM_MID, 0, 4);
    ...
    /*-----创建全遥控菜单项-----*/
    ui_all_DO_button = lv_btn_create(ui_DO_title);
    lv_obj_set_button_init(ui_all_DO_button, lv_pct(100), 20);
    lv_obj_align_to(ui_all_DO_button, ui_point_DO_button, LV_ALIGN_OUT_BOTTOM_MID, 0, 4);
    ui_all_DO_label = lv_label_create(ui_all_DO_button);
    lv_obj_set_label_init(ui_all_DO_label, "All DO", LV_ALIGN_CENTER);
    lv_obj_add_style(ui_all_DO_label, &style_option_unselected, 0);
    lv_obj_set_user_data(ui_all_DO_button, ui_all_DO_label);
    lv_obj_add_event_cb(ui_all_DO_button, ui_DO_event, LV_EVENT_ALL, NULL);
...
void ui_DO_screen_destroy(void)
{
    if(ui_DO_title) lv_obj_del(ui_DO_title);

    // NULL screen variables
    ui_DO_title = NULL;
    ui_DO_title_label = NULL;
    ui_point_DO_button = NULL;
    ui_point_DO_label = NULL;
    ui_all_DO_button = NULL;
    ui_all_DO_label = NULL;
}
