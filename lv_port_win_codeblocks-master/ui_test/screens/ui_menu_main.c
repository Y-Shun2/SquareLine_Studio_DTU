...
// event funtions
void ui_main_menu_event_button(lv_event_t * e)
{
...
//按钮焦点事件回调：切换选中/未选中样式
void ui_main_menu_event_switch(lv_event_t * e)
{
...
void ui_menu_main_screen_init(void)
{
    ...
    // 给按钮添加焦点事件
    lv_obj_add_event_cb(ui_real_data_button, ui_main_menu_event_switch, LV_EVENT_ALL, NULL);
    ...
    // 给按钮添加焦点事件
    lv_obj_add_event_cb(ui_event_record_button, ui_main_menu_event_switch, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_event_record_button, ui_main_menu_event_button, LV_EVENT_ALL, NULL);
    ...
    // 给按钮添加焦点事件
    lv_obj_add_event_cb(ui_dz_param_button, ui_main_menu_event_switch, LV_EVENT_ALL, NULL);
    ...
    // 给按钮添加焦点事件
    lv_obj_add_event_cb(ui_com_param_button, ui_main_menu_event_switch, LV_EVENT_ALL, NULL);
    ...
    // 给按钮添加焦点事件
    lv_obj_add_event_cb(ui_sys_maintain_button, ui_main_menu_event_switch, LV_EVENT_ALL, NULL);
    ...
    // 给按钮添加焦点事件
    lv_obj_add_event_cb(ui_clock_set_button, ui_main_menu_event_switch, LV_EVENT_ALL, NULL);
    ...
    // 给按钮添加焦点事件
    lv_obj_add_event_cb(ui_dev_manage_button, ui_main_menu_event_switch, LV_EVENT_ALL, NULL);
    ...
    // 给按钮添加焦点事件
    lv_obj_add_event_cb(ui_FA_state_button, ui_main_menu_event_switch, LV_EVENT_ALL, NULL);

    // 将按钮添加到对象组中，使其可被输入设备导航
    lv_group_add_obj(group, ui_real_data_button);
    lv_group_add_obj(group, ui_event_record_button);
    lv_group_add_obj(group, ui_dz_param_button);
    lv_group_add_obj(group, ui_com_param_button);
    lv_group_add_obj(group, ui_sys_maintain_button);
    lv_group_add_obj(group, ui_clock_set_button);
    lv_group_add_obj(group, ui_dev_manage_button);
    lv_group_add_obj(group, ui_FA_state_button);

    lv_indev_set_group(indev, group); // 将输入设备与对象组关联

    lv_group_focus_obj(ui_real_data_button);
}
