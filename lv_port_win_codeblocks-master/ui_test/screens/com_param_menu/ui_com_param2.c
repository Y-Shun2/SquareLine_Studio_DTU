...
lv_group_t * ui_com_param2_group = NULL;
lv_obj_t * ui_com_param2_title = NULL;
lv_obj_t * ui_com_param2_title_label = NULL;
lv_obj_t * ui_serial_param_button = NULL;
lv_obj_t * ui_serial_param_label = NULL;
lv_obj_t * ui_com_param3_button = NULL;
lv_obj_t * ui_com_param3_label = NULL;
lv_obj_t * ui_101_param_button = NULL;
lv_obj_t * ui_101_param_label = NULL;
lv_obj_t * ui_104_param_button = NULL;
lv_obj_t * ui_104_param_label = NULL;
...
// event funtions
void ui_com_param2_event(lv_event_t * e)
{
    ...
    switch(event_code)
    {
        ...
        case LV_EVENT_KEY:
            ...
            {
                case LV_KEY_ENTER:
                    if (btn == ui_serial_param_button)
                    {
                        lv_indev_set_group(indev, ui_serial_param_group);
                        _ui_screen_change(&ui_serial_param_title, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_serial_param_screen_init);
                    }
                    if (btn == ui_com_param3_button)
                    {
                        lv_indev_set_group(indev, ui_com_param3_group);
                        _ui_screen_change(&ui_com_param3_title, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_com_param3_screen_init);
                    }
                    if (btn == ui_101_param_button)
                    {
                        lv_indev_set_group(indev, ui_101_param_group);
                        _ui_screen_change(&ui_101_param_title, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_101_param_screen_init);
                    }
                    if (btn == ui_104_param_button)
                    {
                        lv_indev_set_group(indev, ui_104_param_group);
                        _ui_screen_change(&ui_104_param_title, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_104_param_screen_init);
                    }
                    break;
...
// build funtions
void ui_com_param2_screen_init(void)
{
    ui_com_param2_title = lv_obj_create(NULL);
    lv_obj_clear_flag(ui_com_param2_title, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_com_param2_group = lv_group_create(); // 创建一个新的对象组
    lv_indev_t *indev = lv_win32_keypad_device_object;
    ...
    /*-----创建串口参数菜单项-----*/
    ui_serial_param_button = lv_btn_create(ui_com_param2_title);
    ...
    /*-----创建网口参数菜单项-----*/
    ui_com_param3_button = lv_btn_create(ui_com_param2_title);
    ...
    /*-----创建101参数菜单项-----*/
    ui_101_param_button = lv_btn_create(ui_com_param2_title);
    ...
    /*-----创建104参数菜单项-----*/
    ui_104_param_button = lv_btn_create(ui_com_param2_title);
    ...
    lv_group_add_obj(ui_com_param2_group, ui_serial_param_button);
    lv_group_add_obj(ui_com_param2_group, ui_com_param3_button);
    lv_group_add_obj(ui_com_param2_group, ui_101_param_button);
    lv_group_add_obj(ui_com_param2_group, ui_104_param_button);

    lv_indev_set_group(indev, ui_com_param2_group); // 将输入设备与对象组关联

    lv_group_focus_obj(ui_serial_param_button);
}

void ui_com_param2_screen_destroy(void)
{
    if(ui_com_param2_title) lv_obj_del(ui_com_param2_title);

    // NULL screen variables
    ui_com_param2_title = NULL;
    ui_com_param2_title_label = NULL;
    ui_serial_param_button = NULL;
    ui_serial_param_label = NULL;
    ui_com_param3_button = NULL;
    ui_com_param3_label = NULL;
    ui_101_param_button = NULL;
    ui_101_param_label = NULL;
    ui_104_param_button = NULL;
    ui_104_param_label = NULL;
}
