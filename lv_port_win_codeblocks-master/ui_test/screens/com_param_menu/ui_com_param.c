...
// event funtions
void ui_com_param_event(lv_event_t * e)
{
...
// build funtions
void ui_com_param_screen_init(void)
{
    ui_com_param_title = lv_obj_create(NULL);
    lv_obj_clear_flag(ui_com_param_title, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
...
{
    if(ui_com_param_title) lv_obj_del(ui_com_param_title);
